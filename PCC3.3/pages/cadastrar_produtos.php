    ...
    <table border="1" width="100%">
        ...
        <?php foreach($lista as $usuario): ?>
            <tr>
                ...
                <td>
                    <a href="../actions/editar_prod.php?id=<?=$usuario['id_produto'];?>" onclick="return confirm('Você tem certeza que deseja editar esse usuário?')"  style="background-color: green; border-radius:100px; color:white; padding: 3%; margin-right: 10px;">Editar</a> <br>
